...
To install the Pages plugin, run the following command in your terminal:

<PackageManagerTabs>
    <Fragment slot="npm">
        ```shell 
        npm i @lucidcms/plugin-pages
        ```
    </Fragment>
    <Fragment slot="pnpm">
        ```shell 
        pnpm i @lucidcms/plugin-pages 
        ```
    </Fragment>
    <Fragment slot="yarn">
        ```shell 
        yarn add @lucidcms/plugin-pages 
        ```
    </Fragment>
</PackageManagerTabs>
...
```typescript title="lucid.config.ts"
