...
import { addConfigSource } from "../config/utils/with-config-loader.js";
import { collectResourceFiles } from "./collect-files.js";
import { defaultDiscovery, emptyResourceFiles } from "./defaults.js";
import { ResourceDiscoverySchema, ResourceSourcesSchema } from "./schema.js";
import {
	type ResourceFile,
	type ResourceKind,
...
const moduleKinds = new Set<ResourceKind>([
	"collections",
	"tables",
	"routes",
	"hooks",
...
const collectSources = async (
	...
	const discovery = ResourceDiscoverySchema.parse(config.discovery);
