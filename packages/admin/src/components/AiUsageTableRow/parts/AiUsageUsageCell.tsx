...
interface AiUsageUsageCellProps {
	column?: string;
	aiUsage: AiUsage;
}

const AiUsageUsageCell: Component<AiUsageUsageCellProps> = (props) => {
	const tokenRows = () => [
		{
	...
	// Render
	return (
		<Table.Cell column={props.column} minWidth={240}>
...
export default AiUsageUsageCell;
