	...
	return (
		<DropdownMenu.Root placement={props.options?.placement}>
			<DropdownMenu.Trigger
				...
				class={classNames(
					"dropdown-trigger pointer-events-auto min-w-7 w-7 h-7 bg-container-3 outline-none ring-0 focus:ring-1 focus:ring-primary-base rounded-md flex justify-center items-center hover:bg-container-4",
					{
