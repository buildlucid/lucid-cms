...
const TimelineCardWrapper: Component<{
	...
	return (
		<div class="relative flex flex-col">
			<span
				class={classNames(
					"absolute -left-4 top-4 w-3 h-3 rounded-full border -translate-x-1/2",
					{
						"border-primary-base bg-primary-base": isSelected(),
						"border-secondary-base bg-background-base": !isSelected(),
					},
				)}
			/>
			{/* latest / revision */}
