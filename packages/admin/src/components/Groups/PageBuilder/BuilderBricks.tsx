...
const BuilderBrickRow: Component<BuilderBrickRowProps> = (props) => {
	...
	return (
		<li
			...
			class={classNames(
				"drag-item w-full bg-card-base border border-border rounded-md mb-4 last:mb-0 focus-within:outline-hidden focus-within:ring-1 ring-inset ring-primary-base",
				{
