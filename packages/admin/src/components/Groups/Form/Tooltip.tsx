			...
			<HoverCard.Root>
				<HoverCard.Trigger
					class={classnames(
						...
						{
							"top-1/2 -translate-y-1/2 right-2": props.theme === "full",
				...
				<HoverCard.Portal>
					<HoverCard.Content class="z-50 bg-primary-base w-80 mt-2 rounded-md p-4 border border-primary-hover shadow-xs">
