...
interface DeleteApiIntegrationProps {
...
const DeleteApiIntegration: Component<DeleteApiIntegrationProps> = (props) => {
	// ----------------------------------------
	// Mutations
	const deleteIntegration = api.apiIntegrations.useDeleteSingle({
		onSuccess: () => {
...
export default DeleteApiIntegration;
