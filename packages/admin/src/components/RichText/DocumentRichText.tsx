...
export interface DocumentRichTextProps {
	id: string;
...
interface EditorFieldProps extends Omit<DocumentRichTextProps, "translations"> {
	fullscreen: boolean;
	onFullscreenChange: (fullscreen: boolean) => void;
}
...
export const DocumentRichText: Component<DocumentRichTextProps> = (props) => {
	// ----------------------------------------
	// State & Hooks
