...
} from "@/store/pageBuilderModalsStore/pageBuilderModalsStore";
				...
				<Switch>
					...
					<Match when={!isMultiple() && primarySelectedMedia()}>
						<div class="w-full  border border-border rounded-md bg-input-base overflow-hidden group">
							...
							>
								<div class="z-20 flex flex-wrap items-center gap-2 absolute top-0 left-0 right-0 p-3 bg-linear-to-b from-black/45 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
									<Show
										when={
